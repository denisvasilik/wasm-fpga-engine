...
setuptools.setup(
    ...
    package_data={},
    data_files=[
        ("wasm-fpga-engine/package", ["package/component.xml"]),
        ("wasm-fpga-engine/package/bd", ["package/bd/bd.tcl"]),
        ("wasm-fpga-engine/package/xgui", ["package/xgui/wasm_fpga_engine_v1_0.tcl"]),
        (
            "wasm-fpga-engine/resources",
            [
                "resources/wasm_fpga_bus_header.vhd",
                "resources/wasm_fpga_bus_wishbone.vhd",
                "resources/wasm_fpga_engine_direct.vhd",
                "resources/wasm_fpga_engine_header.vhd",
                "resources/wasm_fpga_engine_indirect.vhd",
        ...
        ("wasm-fpga-engine", ["CHANGELOG.md", "AUTHORS", "LICENSE"]),
    ],
    setup_requires=[],
    install_requires=[],
    entry_points={},
